...
- MUSIC：球场与唱片风格的五首歌单，依次为《八方来财》、District Four、Griphop、《快乐崇拜》《花花公子》。所有曲目通过原生音频播放器支持背景播放、随机/顺序切歌、进度、音量及静音；三首中文歌曲使用用户提供的完整 MP3 替代平台试听。全站悬浮播放器在路由切换时连续播放。打开网页时从首曲《八方来财》开始并尝试自动播放，浏览器禁止有声自动播放时等待首次点击/按键或播放按钮；暂停只影响当前访问；重新打开或刷新会重新尝试首曲，静音、音量与随机模式仍会保留。
...
Lighting 的十八件作品采用用户提供的 d1–d18 图片，首位展示 2016 年《驯龙高手》，另包括日式暮色街道、装甲载具、齿轮工坊、2018 年《小破孩之大状元》电影、2017 年阿凡提集市、晶谷远征、2016 年《怪物猎人》、星夜旅居、2024 年《熊出没》和霓虹女武者。WORK 默认打开 Lighting，也可直接访问 `#/work?category=lighting`；分类写入地址，刷新后保留。Lighting 仅保留 GSAP 深度翻页展示，不再重复平铺作品；All、其他分类和收藏页仍使用网格。
...
- `public/works/lighting/d1.webp` 至 `d18.webp`：十八张灯光作品，按源图比例压缩为 WebP；详情页按原始比例完整展示。`d18.webp` 对应首位的《驯龙高手》。未指定的作品年份按用户要求分散在 2019–2026，《驯龙高手》《怪物猎人》为 2016，《小破孩之大状元》电影为 2018，阿凡提集市为 2017，《熊出没》为 2024，均为展示年份而非图片元数据。
...
- `src/data/music.ts`：五首本地背景曲目的标题、作者与来源；`public/music/`：District Four、Griphop 两首 Kevin MacLeod 的 CC BY 4.0 音乐，以及用户提供的《八方来财》《快乐崇拜》《花花公子》完整录音和来源记录。两首 Kevin MacLeod 曲目采用 128 kbps MP3，三首中文歌曲采用 192 kbps MP3，均保留完整时长；MUSIC 页提供署名与来源信息。三首用户提供的录音不纳入 CC 授权。
...
`npx playwright test tests/browser/navigation-music.spec.ts` 验证导航联动、实际音频播放、快进、随机播放、自动播放受限后的恢复、暂停后的重新访问及手机布局。测试地址配置同轮播测试。
